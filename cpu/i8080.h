...
public:
    ...
    */
    ...
    /** 
        ...
        @param opcode 8-bit opcode to execute
    */
    virtual void interrupt( unsigned char opcode );
...
protected:
    ...
    */
    ...
    void opcode_c7();   // RST  00H         / RST 0     (restart from 0000h)
