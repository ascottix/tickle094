...
static TMachineInfo TestMachineInfo = { 
    "tickle", "Tickle", "http://www.ascotti.org/", 2011, ScreenWidth, ScreenHeight, 256, 60
};
...
TTickleMachine::TTickleMachine()
{
    ...
    for( i=0; i<256; i++ ) {
        for( int y=0; y<8; y++ ) {
            ...
            for( int x=0; x<8; x++ ) {
                unsigned color = (b & (1 << x)) ? 0xFFFFFF : 0x000000;
                
                font_->setPixel( 7-x, i*8+y, color );
            }
        }
    }
