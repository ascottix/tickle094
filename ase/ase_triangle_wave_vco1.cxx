...
*/
ATriangleWaveVCO::ATriangleWaveVCO( double rampTime1, double rampTime2 )
{
...
void ATriangleWaveVCO::mix( int * buf, int len )
{
    while( len > 0 ) {
        ...
        double p2 = ASE::samplesPerMs * (4.0 / pow(vout_[0], 1.12 )); // Obtained by simulation and then regression
